        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <header className="bg-blue-600 text-white">
                <div className="mx-auto max-w-4xl px-4 py-6 sm:px-6 lg:px-8">
                    <Link href="/coding-contests" className="text-blue-200 hover:text-white text-sm mb-2 inline-flex items-center gap-1 transition-colors">
                        <ArrowLeft className="w-4 h-4" />
                        Back to Contests
                    </Link>
                    <h1 className="text-3xl font-bold">Create New Contest</h1>
                    <p className="text-blue-200 mt-1">Set up a competitive coding contest for your organization</p>
                </div>
            </header>
            ...
            <main className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
                ...
                <div className="bg-white border border-gray-200 rounded-2xl p-6 md:p-8">
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    className="w-full rounded-lg bg-white border border-gray-300 px-4 py-3 text-gray-900 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/40"
                                >
                                ...
                                {errors.organizationId && (
                                    <p className="mt-1 text-sm text-red-600">{errors.organizationId[0]}</p>
                                )}
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full rounded-lg bg-white border border-gray-300 px-4 py-3 text-gray-900 placeholder-gray-400 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/40"
                                />
                                {errors.title && (
                            ...
                            <div>
                                ...
                                <div className="flex rounded-lg overflow-hidden">
                                    <span className="inline-flex items-center bg-gray-50 border border-r-0 border-gray-300 px-4 text-gray-500 text-sm">
                                        /coding-contests/
                                    </span>
                                    <input
                                        type="text"
                                        ...
                                        className="flex-1 bg-white border border-gray-300 px-4 py-3 text-gray-900 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/40"
                                    />
                                </div>
                                {errors.slug && (
                    ...
                    {step === 2 && (
                        <div className="space-y-6">
                            <div>
                                <h2 className="text-xl font-semibold text-gray-900 mb-4">Schedule & Timing</h2>
                            </div>
                            ...
                            <div>
                                ...
                                />
                                {errors.duration && (
                                    <p className="mt-1 text-sm text-red-600">{errors.duration[0]}</p>
                                )}
                            </div>
                    ...
                    {step === 3 && (
                        <div className="space-y-6">
                            <div>
                                <h2 className="text-xl font-semibold text-gray-900 mb-4">Contest Settings</h2>
                            </div>
                                ...
                                <div className="mt-4 p-4 rounded-lg bg-amber-50 border border-amber-200">
                                    ...
                                    <div className="flex items-center gap-4">
                                        <input
                                            ...
                                            className="flex-1"
                                        />
                                        <span className="text-gray-900 font-mono">{formData.negativePercent}%</span>
                                    </div>
                    ...
                    {step === 4 && (
                        <div className="space-y-6">
                            <div>
                                <h2 className="text-xl font-semibold text-gray-900 mb-2">Proctoring Settings</h2>
                            ...
                            <div className="p-4 rounded-lg bg-blue-50 border border-blue-200">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">Turn on anti-cheating features</p>
                                    </div>
                                    <button
                                        type="button"
                                        onClick={() => updateField("proctorEnabled", !formData.proctorEnabled)}
                                        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                                            formData.proctorEnabled ? "bg-blue-600" : "bg-gray-300"
                                        }`}
                                    >
                                        <span
                                            className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="p-4 rounded-lg bg-gray-50 border border-gray-200">
                                        <div className="flex items-center gap-3 mb-4">
                                            ...
                                            <div>
                                                <h4 className="font-medium text-gray-900">Tab Switch Limit</h4>
                    ...
                    <div className="mt-8 flex items-center justify-between pt-6 border-t border-gray-200">
                        <button
                            ...
                            disabled={step === 1}
                            className="px-6 py-3 rounded-lg text-gray-500 hover:text-gray-900 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                        >
                            ← Previous
                        </button>
                        ...
                        {step < 4 ? (
                            ...
                            <button
                                ...
                                disabled={isLoading}
                                className="px-8 py-3 rounded-lg bg-blue-600 text-white font-semibold hover:bg-blue-700 disabled:opacity-50 transition-colors flex items-center gap-2"
                            >
                                {isLoading ? (
                                    <>
