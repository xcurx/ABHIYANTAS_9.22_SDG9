                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="font-bold text-xl text-gray-900">Innovation Hub</span>
                        </div>
                        <div className="hidden md:flex items-center gap-8">
                            ...
                            <Link href="#for-whom" className="text-gray-600 hover:text-gray-900 text-sm font-medium">
                                For Whom
                            </Link>
                        </div>
            ...
            <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link
                            href="/sign-up"
                            className="rounded-full bg-indigo-600 px-8 py-4 text-base font-semibold text-white hover:bg-indigo-500 transition-colors shadow-lg shadow-indigo-200"
                        >
                            Start Your Journey
                        </Link>
                        <Link
                            href="/hackathons"
                            className="rounded-full bg-white px-8 py-4 text-base font-semibold text-gray-900 hover:bg-gray-50 transition-colors border border-gray-200"
                        >
                            Explore Hackathons
                        </Link>
                    </div>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={feature.title} className="bg-gray-50 rounded-2xl p-6 hover:bg-gray-100 transition-colors">
                    ...
                    <div className="grid md:grid-cols-4 gap-8">
                        {[
                            ...
                            <div key={item.step} className="text-center relative">
                                <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-indigo-600 text-white text-xl font-bold mb-4">
                                    {item.step}
                                </div>
                                {index < 3 && (
            ...
            <section id="for-whom" className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="border border-gray-200 rounded-2xl p-8 hover:border-indigo-300 hover:shadow-lg transition-all">
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-indigo-600">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link
                            href="/sign-up"
                            className="rounded-full bg-white px-8 py-4 text-base font-semibold text-indigo-600 hover:bg-indigo-50 transition-colors"
                        >
                            Create Free Account
                        </Link>
                        <Link
                            href="/hackathons"
                            className="rounded-full bg-indigo-500 px-8 py-4 text-base font-semibold text-white hover:bg-indigo-400 transition-colors border border-indigo-400"
                        >
                            Browse Hackathons
                        </Link>
                    </div>
            ...
            <footer className="bg-gray-900 text-gray-400 py-12 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto">
                    <div className="grid md:grid-cols-4 gap-8 mb-8">
                        <div>
                            <div className="flex items-center gap-2 mb-4">
                                ...
                                <span className="font-bold text-lg text-white">Innovation Hub</span>
                            </div>
                            <p className="text-sm">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm">
                                ...
                                <li><Link href="#" className="hover:text-white transition-colors">Host a Hackathon</Link></li>
                            </ul>
                        </div>
                        <div>
                    ...
                    <div className="border-t border-gray-800 pt-8 text-center text-sm">
                        <p>© 2026 Campus Innovation Hub. All rights reserved.</p>
                    </div>
                </div>
            </footer>
        </div>
